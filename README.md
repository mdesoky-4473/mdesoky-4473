...
Full-stack engineer and director of a Master in FinTech & Analytics program at Wake Forest University. Building at the intersection of AI, finance, and education.

### Current Focus
- AI/ML engineering: RAG pipelines, LLM integration, document intelligence
- Full-stack development: Python (FastAPI), JavaScript (React, Express, Node.js)

### Featured Projects
- **[rag-llm-extraction](https://github.com/mdesoky-4473/rag-llm-extraction)** — RAG pipeline with document upload, TF-IDF retrieval, Claude integration, confidence scoring, and guardrails
